...
export default function PacientePage() {
  ...
  if (isLoading || isLoadingModules) return <PacienteSkeleton />;
  ...
  return (
    <div className="space-y-6">
      <PacienteHeader paciente={paciente} hasOftalmo={hasOftalmo} />
      <PacienteInfo paciente={paciente} hasOftalmo={hasOftalmo} />
      {hasOftalmo ? (
        <PacienteLaudos
